...
{
    public class PendingPaymentAdvertisementsPerAdvertiserQuery
    {
        private readonly IAdvertisementRepository _advertisementRepository;

        public PendingPaymentAdvertisementsPerAdvertiserQuery(IAdvertisementRepository advertisementRepository)
        {
        ...
        public IEnumerable<Advertisement> Get(int advertiserId)
        {
            var advertisements = _advertisementRepository.GetByAdvertiser(advertiserId)
                                                         .Where(a => a.Status == Domain.AdvertisementStatus.PendingPayment);
